...
VL_ATTR_COLD void Vpyhdl_call_if___024unit___ctor_var_reset(Vpyhdl_call_if___024unit* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vpyhdl_call_if__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vpyhdl_call_if___024unit___ctor_var_reset\n"); );
}
